...
root_path = 'C:\\Users\\Kaihang Zhang\\Desktop\\Social_Force_final-master\\'
imgname = 's.jpg'
...
generation.generate_population_plot(population_coordinate_set, img, 00, root_path)
...
for iteration_time in range(100):
    ...
    if iteration_time%10==0:
        generation.generate_population_plot(population_coordinate_set, img, iteration_time, root_path)
